...
<body class="bg-gray-50">
            ...
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex-shrink-0">
                        ...
                        <img class="h-12 w-auto" src="images/logo.png" alt="QuantumByte Technologies Logo">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="animate__animated animate__fadeInLeft">
                    ...
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">Innovative IT Solutions <span class="text-blue-200">Since 2005</span></h1>

                    <p class="text-lg md:text-xl text-blue-100 mb-8">QuantumByte Technologies delivers cutting-edge IT services to help your business thrive in the digital age.</p>

                    <div class="flex flex-col sm:flex-row gap-4">

                        <a href="#services" class="bg-white text-blue-600 hover:bg-blue-50 px-6 py-3 rounded-lg font-medium text-center transition duration-300">Our Services</a>

                        <a href="#contact" class="border-2 border-white text-white hover:bg-blue-700 px-6 py-3 rounded-lg font-medium text-center transition duration-300">Contact Us</a>
                ...
                <div class="animate__animated animate__fadeInRight">
                    ...
                    <img src="images/1.jpg" alt="IT Solutions" class="rounded-lg shadow-2xl floating">
    ...
    <section id="about" class="py-20 bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">About <span class="text-blue-600">QuantumByte</span></h2>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="animate__animated animate__fadeInRight">
                    ...
                    <p class="text-gray-600 mb-6">QuantumByte Technologies Private Limited is a premier IT service provider with a strong presence in Gurugram and Nagpur. Since our inception in 2005, we've been delivering innovative technology solutions to businesses across various industries.</p>

                    <p class="text-gray-600 mb-6">Our team of certified professionals combines technical expertise with business acumen to provide customized solutions that drive growth and efficiency for our clients.</p>
    ...
    <section id="services" class="py-20 bg-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Our <span class="text-blue-600">Services</span></h2>

                <p class="text-lg text-gray-600 max-w-3xl mx-auto">Comprehensive IT solutions designed to propel your business forward in the digital landscape.</p>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="service-card bg-white rounded-xl shadow-md overflow-hidden transition duration-500 ease-in-out hover:shadow-xl animate__animated animate__fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600">Custom software solutions tailored to your business requirements, from enterprise applications to mobile apps.</p>
                ...
                <div class="service-card bg-white rounded-xl shadow-md overflow-hidden transition duration-500 ease-in-out hover:shadow-xl animate__animated animate__fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600">Comprehensive cloud services including migration, management, and optimization across all major platforms.</p>
                ...
                <div class="service-card bg-white rounded-xl shadow-md overflow-hidden transition duration-500 ease-in-out hover:shadow-xl animate__animated animate__fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600">End-to-end security solutions including risk assessment, penetration testing, and managed security services.</p>
                ...
                <div class="service-card bg-white rounded-xl shadow-md overflow-hidden transition duration-500 ease-in-out hover:shadow-xl animate__animated animate__fadeInUp" data-wow-delay="0.4s">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600">Transform your data into actionable insights with our advanced analytics and business intelligence solutions.</p>
                ...
                <div class="service-card bg-white rounded-xl shadow-md overflow-hidden transition duration-500 ease-in-out hover:shadow-xl animate__animated animate__fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600">Cross-platform and native mobile applications that deliver seamless user experiences across all devices.</p>
                ...
                <div class="service-card bg-white rounded-xl shadow-md overflow-hidden transition duration-500 ease-in-out hover:shadow-xl animate__animated animate__fadeInUp" data-wow-delay="0.6s">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600">Strategic IT consulting services to align your technology with business goals and drive digital transformation.</p>
    ...
    <section id="history" class="py-20 bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Our <span class="text-blue-600">Journey</span></h2>

                <p class="text-lg text-gray-600 max-w-3xl mx-auto">From humble beginnings to becoming a trusted IT partner for businesses across India.</p>
    ...
    <section class="py-20 bg-blue-600 text-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                ...
                <h2 class="text-3xl md:text-4xl font-bold mb-4">Client <span class="text-blue-200">Testimonials</span></h2>

                <p class="text-lg text-blue-100 max-w-3xl mx-auto">Hear what our clients say about working with QuantumByte Technologies.</p>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white bg-opacity-10 rounded-xl p-8 backdrop-filter backdrop-blur-sm animate__animated animate__fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="text-blue-50 mb-6">"QuantumByte transformed our legacy systems into modern cloud-based solutions, improving our operational efficiency by 40%. Their team was professional and delivered beyond our expectations."</p>
                ...
                <div class="bg-white bg-opacity-10 rounded-xl p-8 backdrop-filter backdrop-blur-sm animate__animated animate__fadeInUp" data-wow-delay="0.2s">
                    ...
                    <p class="text-blue-50 mb-6">"Their cybersecurity team helped us identify vulnerabilities we didn't even know existed. The implementation was smooth and their ongoing support has been exceptional."</p>
                ...
                <div class="bg-white bg-opacity-10 rounded-xl p-8 backdrop-filter backdrop-blur-sm animate__animated animate__fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="text-blue-50 mb-6">"We've been working with QuantumByte since 2010 and they've consistently delivered innovative solutions that give us a competitive edge in our industry."</p>
    ...
    <div class="h-96 w-full">
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3507.715635623628!2d77.0903723150789!3d28.45744498248345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d1858d9a9c663%3A0x3a9d1d9b3e8a7f8a!2sParsvnath%20Greenville%2C%20Sector%2048%2C%20Gurugram%2C%20Haryana%20122018!5e0!3m2!1sen!2sin!4v1620000000000!5m2!1sen!2sin" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <img src="images/logo.png" alt="QuantumByte Technologies Logo" class="h-12 mb-6">

                    <p class="text-gray-400 mb-6">Innovative IT solutions provider since 2005, helping businesses transform through technology.</p>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="#history" class="text-gray-400 hover:text-white transition duration-300">Our Journey</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="#" class="text-gray-400 hover:text-white transition duration-300">Cloud Solutions</a></li>
                        ...
                        <li><a href="#" class="text-gray-400 hover:text-white transition duration-300">IT Consulting</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-400">122018, Badshahpur Sohna Rd Hwy, Parsvnath Greenville, Sector 48, Gurugram, Haryana</span>
            ...
            <div class="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
                ...
                <p class="text-gray-500 text-sm mb-4 md:mb-0">© 2023 QuantumByte Technologies Private Limited. All rights reserved.</p>
