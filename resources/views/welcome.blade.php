...
<body class="bg-gray-50">
    ...
    <nav class="bg-white shadow-lg sticky top-0 z-50">
            ...
            <div class="flex justify-between h-20 items-center">
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-6">
                            <a href="#home"
                                class="text-blue-600 hover:text-blue-800 px-3 py-2 rounded-md text-sm font-medium transition duration-300">Home</a>
                            <a href="#about"
                                class="text-gray-700 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition duration-300">About</a>
                            <a href="#services"
                                class="text-gray-700 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition duration-300">Services</a>
                            <a href="#history"
                                class="text-gray-700 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition duration-300">Our
                                Journey</a>
                            <a href="#contact"
                ...
                <div class="md:hidden">
                    <button id="mobile-menu-button" type="button"
                        class="inline-flex flex-col items-center justify-center p-2 rounded-md text-gray-700 hover:text-blue-600 hover:bg-gray-100 focus:outline-none transition duration-300">
        ...
        <div id="mobile-menu" class="mobile-menu md:hidden bg-white border-t border-gray-200">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <a href="#about"
                    class="text-gray-700 hover:bg-gray-100 block px-3 py-2 rounded-md text-base font-medium">About</a>
                <a href="#services"
                    class="text-gray-700 hover:bg-gray-100 block px-3 py-2 rounded-md text-base font-medium">Services</a>
                <a href="#history"
                    class="text-gray-700 hover:bg-gray-100 block px-3 py-2 rounded-md text-base font-medium">Our
                    Journey</a>
                <a href="#contact"
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="animate__animated animate__fadeInLeft">
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">Innovative IT Solutions
                        <span class="text-blue-200">Since 2005</span>
                    </h1>
                ...
                <div class="animate__animated animate__fadeInRight">
                    <img src="{{asset('images/wallpaper.png')}}" alt="IT Solutions"
    ...
    <section id="history" class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative">
                <!-- Timeline line -->
                <div
                    class="border-l-2 border-blue-200 absolute h-full left-4 md:left-1/2 transform md:-translate-x-1/2">
                </div>
                ...
                <div class="space-y-12">
                    ...
                    <div class="relative pl-12 md:pl-0 md:flex justify-between items-center">
                        <div class="md:w-5/12 md:pr-8 md:text-right mb-6 md:mb-0 animate__animated animate__fadeInLeft">
                            ...
                            <p class="text-gray-600 mt-2">QuantumByte Technologies was founded in Gurugram with a small
                                team of 5 IT enthusiasts.</p>
                        </div>
                    ...
                    <div class="relative pl-12 md:pl-0 md:flex justify-between items-center">
                        <div class="md:w-5/12 md:order-last md:pl-8 animate__animated animate__fadeInRight">
                            ...
                            <p class="text-gray-600 mt-2">Secured our first enterprise client, marking our transition
                                from small projects to large-scale implementations.</p>
                        </div>
                        <div class="hidden md:block md:w-2/12 flex justify-center">
                            <div class="h-4 w-4 bg-blue-600 rounded-full border-4 border-blue-100"></div>
                        </div>
                    ...
                    <div class="relative pl-12 md:pl-0 md:flex justify-between items-center">
                        <div class="md:w-5/12 md:pr-8 md:text-right mb-6 md:mb-0 animate__animated animate__fadeInLeft">
                            ...
                            <p class="text-gray-600 mt-2">Opened our second office in Nagpur IT Park to serve clients in
                                Central India more effectively.</p>
                        </div>
                        <div class="hidden md:block md:w-2/12 flex justify-center">
                            <div class="h-4 w-4 bg-blue-600 rounded-full border-4 border-blue-100"></div>
                        </div>
                    ...
                    <div class="relative pl-12 md:pl-0 md:flex justify-between items-center">
                        <div class="md:w-5/12 md:order-last md:pl-8 animate__animated animate__fadeInRight">
                            ...
                            <p class="text-gray-600 mt-2">Launched our cloud services division, becoming one of the
                                early adopters of cloud technologies in India.</p>
                        </div>
                        <div class="hidden md:block md:w-2/12 flex justify-center">
                            <div class="h-4 w-4 bg-blue-600 rounded-full border-4 border-blue-100"></div>
                        </div>
                    ...
                    <div class="relative pl-12 md:pl-0 md:flex justify-between items-center">
                        <div class="md:w-5/12 md:pr-8 md:text-right mb-6 md:mb-0 animate__animated animate__fadeInLeft">
                            ...
                            <p class="text-gray-600 mt-2">Crossed the milestone of 100 employees, with teams now serving
                                clients across 12 countries.</p>
                        </div>
                        <div class="hidden md:block md:w-2/12 flex justify-center">
                            <div class="h-4 w-4 bg-blue-600 rounded-full border-4 border-blue-100"></div>
                        </div>
    ...
    <section class="py-20 bg-blue-600 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="bg-white bg-opacity-10 rounded-xl p-8 backdrop-filter backdrop-blur-sm animate__animated animate__fadeInUp"
                    data-wow-delay="0.1s">
                    <div class="flex items-center mb-4">
                        <div class="text-yellow-400 text-2xl">★★★★★</div>
                    </div>
                    <p class="text-blue-50 mb-6">
                        "QuantumByte transformed our legacy systems into modern cloud-based solutions, improving our
                        operational efficiency by 40%. Their team was professional and delivered beyond our
                        expectations."
                    </p>
                    <div class="flex items-center">
                        <img class="h-12 w-12 rounded-full mr-4" src="https://randomuser.me/api/portraits/men/32.jpg"
                            alt="Client">
                        <div>
                ...
                <div class="bg-white bg-opacity-10 rounded-xl p-8 backdrop-filter backdrop-blur-sm animate__animated animate__fadeInUp"
                    ...
                    <p class="text-blue-50 mb-6">
                        "Their cybersecurity team helped us identify vulnerabilities we didn't even know existed. The
                        implementation was smooth and their ongoing support has been exceptional."
                    </p>
                    <div class="flex items-center">
                        <img class="h-12 w-12 rounded-full mr-4" src="https://randomuser.me/api/portraits/women/44.jpg"
                            alt="Client">
                        <div>
                ...
                <div class="bg-white bg-opacity-10 rounded-xl p-8 backdrop-filter backdrop-blur-sm animate__animated animate__fadeInUp"
                    ...
                    <p class="text-blue-50 mb-6">
                        "We've been working with QuantumByte since 2010 and they've consistently delivered innovative
                        solutions that give us a competitive edge in our industry."
                    </p>
                    <div class="flex items-center">
                        <img class="h-12 w-12 rounded-full mr-4" src="https://randomuser.me/api/portraits/men/75.jpg"
                            alt="Client">
                        <div>
    ...
    <section id="contact" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Get In <span
                        class="text-blue-600">Touch</span></h2>
                <p class="text-lg text-gray-600 max-w-3xl mx-auto">Have a project in mind or want to learn more about
                    our services? Contact us today.</p>
                <div class="w-20 h-1 bg-blue-600 mx-auto mt-4"></div>
            </div>
                ...
                <div class="animate__animated animate__fadeInLeft">
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600 mt-1">122018, Badshahpur Sohna Rd Hwy, Parsvnath Greenville,
                                        Tatvam Villas, Sector 48, Gurugram, Haryana 122018</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <div class="flex-shrink-0 bg-blue-100 p-3 rounded-lg">
                    ...
                    <div class="mt-8 bg-gray-50 rounded-xl p-8 shadow-md">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                <p class="text-gray-600">IT Park, 5th Floor, TechZone Building, Hingna Road, Nagpur,
                ...
                <div class="animate__animated animate__fadeInRight">
                    <div class="bg-gray-50 rounded-xl p-8 shadow-md">
                        ...
                        <form class="space-y-6">
                            ...
                            <div>
                                <button type="submit"
                                    class="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg transition duration-300">Send
                                    Message</button>
                            </div>
                        </form>
                    </div>
